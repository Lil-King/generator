package com.ebiz.generator.provider.db.model;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;

import com.ebiz.generator.util.ActionScriptDataTypesUtils;
import com.ebiz.generator.util.DatabaseDataTypesUtils;
import com.ebiz.generator.util.StringHelper;
import com.ebiz.generator.util.TestDataGenerator;
...
public class Column {
	...
	public String getColumnName() {
		return StringHelper.toUnderscoreName(getSqlName());
	}
	...
	public boolean getIsClobColumn() {
		return DatabaseDataTypesUtils.isClob(getSqlType(), getSize(), getDecimalDigits());
	}
